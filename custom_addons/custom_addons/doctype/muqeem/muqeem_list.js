    ...
    onload: function (listview) {
        listview.page.add_inner_button("Import Excel/CSV", function () {
            let d = new frappe.ui.Dialog({
                        ...
                        options: `
                            ...
                            ">
                                ...
                                <div style="
                                    ...
                                    margin-bottom: 15px;
                                ">
                                    1. Download the official Muqeem template.<br>
                                    2. Fill in employee details in the same format.<br>
                                    3. Upload the completed Excel or CSV file below.
                                </div>
                                <a
                                    href="/api/method/custom_addons.custom_addons.doctype.muqeem.muqeem.download_muqeem_template"
                ...
                primary_action(values) {
                    ...
                    frappe.call({
                        method: 'custom_addons.custom_addons.doctype.muqeem.muqeem.import_muqeem_data',
                        args: {
        ...
        listview.page.add_inner_button("Delete All", function () {
            frappe.confirm(
                ...
                () => {
                    frappe.call({
                        method: "custom_addons.custom_addons.doctype.muqeem.muqeem.delete_all_muqeem",
                        freeze: true,
